...
class ManagerDashboardView(View):
    def __init__(self, root, org):
        ...
        self.manager_dashboard_window()

    def manager_dashboard_window(self):
        #Setup
    ...
    def body(self):
        ...
        Utils.Label(self.root, "Welcome to the Manager Dashboard " + users_first_name).pack(fill='x', expand=True)
    ...
    def footer(self):
        ...
        #Shop Button
        Utils.Button(footerFrame, "Manage", lambda:self.open_shop_window()).pack(fill='x', expand=True, side='left')
